...
public final class PermissionUtils {
    ...
    public static boolean isLocationGranted(@NonNull final Context context) {
        return (!isMarshmallowOrLater() || (isPermissionGranted(context, Manifest.permission.ACCESS_COARSE_LOCATION) || isPermissionGranted(context, Manifest.permission.ACCESS_FINE_LOCATION)));
    }
